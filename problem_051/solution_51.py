...
# Хоть тут и не сказано о количестве 'части цифр', минимальное число цифр должно быть кратно 3.
# Вот почему. Как известно, если сумма цифр числа кратна трём, то и само число кратно 3.
# Следовательно, если мы последовательно будем прибавлять к любому числу, которое является суммой цифр числа,
# единицу (0-1-2-3-4-5..) , то сумма цифр числа будет кратна трём минимум 3 раза (только 7 цифр подойдут по условию).
